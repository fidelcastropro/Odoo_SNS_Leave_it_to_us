...
function Dashboard({ user, isDark }) {
  ...
  // Regional destinations with working travel photos
  const regionalDestinations = [
    ...
    { 
      ...
      image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?w=250&h=200&fit=crop&crop=center',
      trips: 15 
    },
    { 
      id: 4, 
    ...
    { 
      ...
      image: 'https://images.unsplash.com/photo-1570168007204-dfb528c6958f?w=250&h=200&fit=crop&crop=center',
      trips: 9 
    }
  ]
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 pb-8">
        ...
        {/* Top Regional Selections - No scroll bar */}
