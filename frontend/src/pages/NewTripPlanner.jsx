...
function NewTripPlanner({ user, isDark }) {
  ...
  // Hardcoded suggestions for Tamil Nadu & Kerala
  const allSuggestions = [
    { id: 1, name: 'Meenakshi Temple', state: 'Tamil Nadu', city: 'Madurai', imageUrl: 'https://via.placeholder.com/300x200?text=Meenakshi+Temple' },
    { id: 2, name: 'Marina Beach', state: 'Tamil Nadu', city: 'Chennai', imageUrl: 'https://via.placeholder.com/300x200?text=Marina+Beach' },
    { id: 3, name: 'Ooty Hill Station', state: 'Tamil Nadu', city: 'Ooty', imageUrl: 'https://via.placeholder.com/300x200?text=Ooty+Hills' },
    { id: 4, name: 'Brihadeeswarar Temple', state: 'Tamil Nadu', city: 'Thanjavur', imageUrl: 'https://via.placeholder.com/300x200?text=Brihadeeswarar+Temple' },
    { id: 5, name: 'Kanyakumari Beach', state: 'Tamil Nadu', city: 'Kanyakumari', imageUrl: 'https://via.placeholder.com/300x200?text=Kanyakumari+Beach' },
    { id: 6, name: 'Mahabalipuram Shore Temple', state: 'Tamil Nadu', city: 'Mahabalipuram', imageUrl: 'https://via.placeholder.com/300x200?text=Shore+Temple' },
    { id: 7, name: 'Munnar Tea Gardens', state: 'Kerala', city: 'Munnar', imageUrl: 'https://via.placeholder.com/300x200?text=Munnar+Tea+Gardens' },
    { id: 8, name: 'Alleppey Backwaters', state: 'Kerala', city: 'Alleppey', imageUrl: 'https://via.placeholder.com/300x200?text=Alleppey+Backwaters' },
    { id: 9, name: 'Varkala Beach', state: 'Kerala', city: 'Varkala', imageUrl: 'https://via.placeholder.com/300x200?text=Varkala+Beach' },
    { id: 10, name: 'Periyar National Park', state: 'Kerala', city: 'Thekkady', imageUrl: 'https://via.placeholder.com/300x200?text=Periyar+Park' },
    { id: 11, name: 'Kochi Fort', state: 'Kerala', city: 'Kochi', imageUrl: 'https://via.placeholder.com/300x200?text=Kochi+Fort' },
    { id: 12, name: 'Athirappilly Waterfalls', state: 'Kerala', city: 'Thrissur', imageUrl: 'https://via.placeholder.com/300x200?text=Athirappilly+Falls' }
  ]
  ...
  return (
    <div className={`min-h-screen ${isDark ? 'bg-slate-900' : 'bg-white'}`}>
      {/* Header */}
      <div className={`flex items-center justify-between p-6 border-b ${isDark ? 'border-gray-700 bg-slate-800' : 'border-gray-200 bg-white'}`}>
        <h1 className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>Glob Trotter</h1>
        <button
