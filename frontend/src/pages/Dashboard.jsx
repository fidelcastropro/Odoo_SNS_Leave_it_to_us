...
function Dashboard({ user, isDark }) {
  ...
  // Sample regional destinations data
  const regionalDestinations = [
    { id: 1, name: 'Tamil Nadu Heritage', image: 'https://via.placeholder.com/250x200?text=Tamil+Nadu', trips: 12 },
    { id: 2, name: 'Kerala Backwaters', image: 'https://via.placeholder.com/250x200?text=Kerala', trips: 8 },
    { id: 3, name: 'Rajasthan Royal', image: 'https://via.placeholder.com/250x200?text=Rajasthan', trips: 15 },
    { id: 4, name: 'Goa Beaches', image: 'https://via.placeholder.com/250x200?text=Goa', trips: 20 },
    { id: 5, name: 'Himachal Hills', image: 'https://via.placeholder.com/250x200?text=Himachal', trips: 6 },
    { id: 6, name: 'Karnataka Culture', image: 'https://via.placeholder.com/250x200?text=Karnataka', trips: 9 }
  ]
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative w-full aspect-[3/1] mb-8">
        <img 
          src="https://via.placeholder.com/1200x400?text=Discover+Your+Next+Adventure" 
          alt="Hero Banner"
